            ...
            <div tw="max-w-md mx-1 w-full bg-lightnav text-white overflow-hidden rounded-lg shadow-2xl  dark:(bg-darknav) px-10" >
                ...
                <form tw="max-w-full w-80 mx-auto py-8" onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <div tw=" mb-3 pb-5 relative" >
                        <label tw="inline-block mb-1 ml-2" >Name</label> 

                        <Input placeholder="Enter the Name" css={[errors.name ? tw`ring ring-red-400  mb-0 ` : tw`ring-blue-400 mb-7`]} {...register("name", {
                        ...
                        {
                            errors.name && <> <VscError tw="absolute h-6 w-6 top-10 right-2 text-red-500" /> <p tw="ml-2 text-red-500 mt-1 " >{errors.name.message}</p> </>
                        }
                    ...
                    <div tw=" mb-3 pb-5 relative" >
                        ...
                        {
                            errors.password && <> <VscError tw="absolute h-6 w-6 top-10 right-2 text-red-500" /> <p tw="ml-2 text-red-500 mt-1 " >{errors.password.message}</p> </>
                        }
                    ...
                    <div tw=" flex mb-3 pb-5 justify-center " >
                        <button type="submit"  tw="py-3  focus:outline-none w-40 text-white text-center bg-indigo-600 hover:bg-indigo-500 rounded-full " >Sign Up</button>
