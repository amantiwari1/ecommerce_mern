...
import { FaFacebookF, FaTwitter, FaPinterestP, FaYoutube, FaInstagram } from "react-icons/fa"
const Footer = () => {
    ...
    return (
        <div tw="grid md:grid-cols-2 lg:grid-cols-3 md:px-32  text-black bg-blue-300  py-10 px-4 bg-darknav text-white"   >
            ...
            <div tw="md:(col-span-2 text-left ) text-center lg:col-auto" >
                <p tw="text-3xl leading-10" >SAMMEE provides a curated experience that will make you a boba connoisseur overnight.✨</p>
            </div>
