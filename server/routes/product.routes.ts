...
product.post("/update/:id", isAuth, Uploder, use(productController.updateProduct));
product.delete("/delete/:id", isAuth, use(productController.deleteProduct));
product.delete("/deleteImage/:id/:folder/:filename", isAuth, use(productController.deleteImageProduct));
